...
虽然看似长篇大论，但整个代码逻辑并不难。限于篇幅，其中还有许多工具函数以及部分逻辑代码或省略，或一笔带过。毕竟这也不是一篇扫盲式的文章的说，虽然我觉得自己已经极尽详细地了。如果你有兴趣的话，我已经将注释过的代码上传至git，你可以clone下来详细阅读：[vue-router](https://github.com/sharminlin/vue-router) (注：微信对外链貌似有限制，建议使用电脑端)。<br />
